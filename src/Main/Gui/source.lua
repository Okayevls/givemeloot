...
local function getService(name)
    ...
    local prompt = useStudio and require(script.Parent.prompt) or loadWithTimeout('https://raw.githubusercontent.com/Okayevls/givemeloot/refs/heads/main/src/Main/Gui/prompt.lua')
...
<font transparency='0.3'>Some scripts may steal your items or in-game goods.</font>]],
    ...
    local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/Okayevls/givemeloot/refs/heads/main/src/Main/Gui/icons.lua')
    -- Variables
